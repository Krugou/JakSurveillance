				...
				<div className="p-6 m-4 bg-white rounded max-h-[30em] overflow-y-scroll shadow-md w-full flex flex-col gap-5 sm:w-3/4 md:w-1/2 2xl:w-1/4 xl:w-1/3">
					...
					<ul className="flex flex-col gap-2">
						<li>
							...
							email address, student ID, and other relevant identification information.
						</li>
						<li>
					...
					<ul className="flex flex-col gap-2">
						...
						<li>
							<label className="font-semibold">Communication: </label>To send important
							updates, notifications, and announcements.
						</li>
					</ul>
					...
					<ul className="flex flex-col gap-2">
						...
						<li>
							<label className="font-semibold">Service Providers: </label>For technical
