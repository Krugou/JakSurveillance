...
const Card: React.FC<CardProps> = ({ path, title, description }) => {
    ...
    return (
        <div onClick={handleCardClick} className="card-link m-5 cursor-pointer">
            <div className="relative bg-white p-4 rounded-md shadow-md transition-transform transform hover:scale-105 group md:w-[15rem] h-[8rem]">
