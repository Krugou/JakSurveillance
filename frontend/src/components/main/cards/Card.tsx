	...
	return (
		<div onClick={handleCardClick} className="card-link m-3 cursor-pointer">
			<div className="relative bg-white p-4 rounded-md shadow-md transition-transform transform hover:scale-105 group w-[15rem] h-[8rem]">
				...
				<div className="flex items-center justify-between p-2 absolute bottom-0 left-0 w-full h-1/2 bg-metropoliaMainOrange rounded-b-md opacity-0 transition-opacity duration-300 ease-in-out sm:group-hover:opacity-100">
